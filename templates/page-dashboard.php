...
<?php while (have_posts()) { ?>
    ...
    <div class="dashboard">
        ...
        <div class="dashboard-content">
            <?php
            if (!$is_no_membership) {
                echo do_shortcode('[elementor-template id="' . dd_get_template_id('dd_tpl_dashboard_content', 1640) . '"]');
            } else {
                echo do_shortcode('[elementor-template id="' . dd_get_template_id('dd_tpl_dashboard_no_access', 14403) . '"]');
            }
            ?>
