...
/**
 * Automatically set initial payment to match billing amount
 * for existing members changing plans (IF they are not under a subscription delay).
 */
function influencer_dynamic_initial_payment( $level ) {
