...
class Widget_Platform_Text extends \Elementor\Widget_Base
{
    ...
    {
        return 'sc_platform_text';
    }
    public function get_title()
    {
        return esc_html__('Platform Text', 'trb-influencer');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_group_control(
            ...
            [
                ...
                // IMPORTANT: Replace '.your-text-selector' with the exact CSS class 
                // that was targeted in the original 'text_size' control's 'selectors' array.
                'selector' => '{{WRAPPER}} .your-text-selector',
            ]
        );
        $this->end_controls_section();
    }
