...
class Widget_Follower_Growth_Chart extends \Elementor\Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->add_control( 'info', [
            ...
            'raw'  => esc_html__( 'Renders [follower_growth_chart]. Displays a bar chart of follower growth over time for the current influencer. Switches with the page platform switcher; this control sets the initial platform.', 'trb-influencer' ),
        ] );
    ...
    protected function render() {
        ...
        echo do_shortcode( '[follower_growth_chart platform="' . esc_attr( $platform ) . '"]' );
    }
}
