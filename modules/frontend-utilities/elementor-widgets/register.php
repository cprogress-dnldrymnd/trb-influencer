...
add_action( 'elementor/widgets/register', function ( \Elementor\Widgets_Manager $wm ) {
    ...
    require_once $dir . 'class-widget-comparison-table.php';
    ...
    require_once $dir . 'class-widget-back-to-search.php';
    ...
    $wm->register( new Widget_Feature_Comparison_Table() );
    ...
    $wm->register( new Widget_Back_To_Search() );
