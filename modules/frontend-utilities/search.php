            ...
            <form class="influencer-search influencer-search-sidebar" action="<?= esc_url($form_action) ?>" method="GET">
                <div class="refine-search-trigger refine-search-open refine-search-heading-block" role="button" tabindex="0">
                    <div class="refine-search-heading">
                        ...
                        <?php } else { ?>
                            <svg class="refine-search-icon" xmlns="http://www.w3.org/2000/svg" width="23.66" height="20" viewBox="0 0 23.66 20">
                    ...
                    <?php if (! empty($refine_subtext)) { ?>
                        <p class="refine-search-subtext refine-search-subtext--trigger"><?= esc_html($refine_subtext) ?></p>
                    <?php } ?>
                ...
                <div class="influencer-search-filter-holder">
                    <div class="refine-search-modal-header">
                        <?php if (! empty($refine_subtext)) { ?>
                            <p class="refine-search-subtext refine-search-subtext--modal"><?= esc_html($refine_subtext) ?></p>
                        <?php } ?>
                    ...
                    <div class="save-this-search">
                        ...
                        <span class="save-search-trigger save-search-locked"
                              ...
                              title="<?= esc_attr(dd_get_message('dd_msg_save_search_upgrade_tooltip')) ?>">Save this search
