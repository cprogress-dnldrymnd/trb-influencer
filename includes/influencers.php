...
class DD_Featured_Influencer_Manager {
	...
	public function enqueue_admin_assets( $hook ) {
		...
		if ( $is_influencer_list ) {
			...
			wp_add_inline_style( 'common', '.column-featured_influencer { width: 80px; text-align: center; } .dd-star-toggle { cursor: pointer; color: #b4b9be; transition: color 0.2s ease; } .dd-star-toggle.is-featured { color: #f56e28; }' );
		}
	...
	public function render_options_page() {
		...
		<div class="wrap dd-options-wrap">
			...
			<?php if ( isset( $_GET['updated'] ) ) : ?>
				<div class="notice notice-success is-dismissible"><p>Settings synchronized and saved.</p></div>
			<?php endif; ?>
