...
<body style="margin:0;padding:20px;background-color:#EBEBEB;color:#1A1A1A;font-family:sans-serif;">
    ...
    ?>
        <style>
            ...
            .dd-archive-link-left {
                display: flex;
                align-items: center;
                gap: 8px;
            }

            .dd-archive-link.active {
                color: #034146;
                font-weight: bold;
            }
            ...
            .dd-action-toggle.dd-action-toggle.dd-action-toggle {
                background: none;
                border: none;
                font-size: 20px;
                cursor: pointer;
