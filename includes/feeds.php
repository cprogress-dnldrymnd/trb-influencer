...
?>
    ...
    private function render_single_card(array $post): string
    {
        ...
        $engageRate = floatval($post['engageRate'] ?? 0);
                ...
                <div class="date-post-stats">
                    ...
                    <div class="post-stats">
                        ...
                        <div class="post-stat-item">
                            ...
                            <span class="text-sm text-gray-900"><?= function_exists('convertDecimalToPercentage') ? convertDecimalToPercentage($engageRate) : $engageRate ?></span>
                        </div>
                    </div>
                </div>
            </div>
