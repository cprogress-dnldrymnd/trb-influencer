...
?>
    ...
    ?>
        <div class="cdb-ig-card">
            <blockquote class="instagram-media" data-instgrm-permalink="<?php echo esc_url($permalink); ?>?utm_source=ig_embed&amp;utm_campaign=loading" data-instgrm-version="14" style="background:#FFF; border:0; border-radius:3px; box-shadow:0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15); margin: 1px; max-width:540px; min-width:326px; padding:0; width:99.375%; width:-webkit-calc(100% - 2px); width:calc(100% - 2px);">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-x-1"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="text-gray-300">
                    ...
                    </svg><span class="text-sm text-gray-900">3</span></div>
                <div class="flex items-center gap-x-1"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="text-gray-300">
                    ...
                    </svg><span class="text-sm text-gray-900">27</span></div>
                <div class="flex items-center gap-x-1"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="text-gray-300">
                    ...
                    </svg><span class="text-sm text-gray-900">0.16%</span></div>
            </div>
        </div>
<?php
        return ob_get_clean();
